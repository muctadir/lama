...
describe('InputCheckService', () => {
  ...
  it('checkFilled should return false when top-level domain is > 3 letters', () => {
  ...
  it('checkFilled should return false when there are 2 addresses.', () => {
